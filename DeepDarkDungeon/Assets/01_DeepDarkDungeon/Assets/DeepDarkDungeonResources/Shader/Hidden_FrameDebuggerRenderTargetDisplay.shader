    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_0 = half4(u_xlat16_0 + (-Globals._Levels.xxxx));
    u_xlat16_1 = half((-Globals._Levels.x) + Globals._Levels.y);
    u_xlat16_0 = half4(u_xlat16_0 / half4(u_xlat16_1));
    u_xlat16_0 = half4(u_xlat16_0 * Globals._Channels);
    u_xlat16_1 = half(dot(float4(u_xlat16_0), float4(1.0, 1.0, 1.0, 1.0)));
    u_xlat16_4 = half(dot(float4(Globals._Channels), float4(1.0, 1.0, 1.0, 1.0)));
    u_xlatb2 = u_xlat16_4==1.0;
    output.SV_Target0 = (bool(u_xlatb2)) ? half4(u_xlat16_1) : u_xlat16_0;
    return output;
}
"
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    bool u_xlatb2;
    half u_xlat16_4;
    u_xlat16_0 = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xyz);
    u_xlat16_0 = half4(u_xlat16_0 + (-Globals._Levels.xxxx));
    u_xlat16_1 = half((-Globals._Levels.x) + Globals._Levels.y);
    u_xlat16_0 = half4(u_xlat16_0 / half4(u_xlat16_1));
    u_xlat16_0 = half4(u_xlat16_0 * Globals._Channels);
